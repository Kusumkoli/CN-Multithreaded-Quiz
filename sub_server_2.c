...
int main(int argc, char** argv) {
    ...
    int ans;
            ...
            print("\n 2. Randra Prasad\n");   // <--- here  you can write any wrong answer which you like 
            scanf("%d",&ans);  ///<-- Here who's address do we want? yes we want 'ans' address 

            if(ans == 1) /// We have used if and else statements
            {
